...
const PALETTE_GROUPS = [
  ['Bodies & Pad', [
    ...
    ['bodylink', 'Spill Link',    {w:60, h:34}],
  ]],
  ['Returns & Suction', [
    ['skimmer',  'Skimmer',       {w:30, h:30, compact:true}],
    ['drain',    'Main Drain',    {w:28, h:28, compact:true}],
    ['return',   'Return',        {w:22, h:22, compact:true}],
  ]],
  ['Features', [
    ['jet',      'Spa Jet',       {w:20, h:20, compact:true}],
    ['bubbler',  'Bubbler',       {w:24, h:24, compact:true}],
    ['deckjet',  'Deck Jet',      {w:26, h:26, compact:true}],
    ['sheer',    'Sheer Descent', {w:38, h:26, compact:true}],
    ['slide',    'Slide',         {w:38, h:28, compact:true}],
    ['autofill', 'Autofill',      {w:26, h:26, compact:true}],
    ['feature',  'Feature',       {w:34, h:26, compact:true}],
    ['light',    'Light',         {w:22, h:22, compact:true}],
    ['custom',   'Custom',        {w:50, h:34, editLabel:true}],
  ]],
  ['Equipment', [
    ['pump',     'Pump',          {w:70, h:46}],
    ['filter',   'Filter',        {w:70, h:46}],
    ['heater',   'Heater',        {w:70, h:46}],
    ['saltcell', 'Salt Cell',     {w:70, h:46}],
    ['booster',  'Booster',       {w:70, h:46}],
    ['blower',   'Air Blower',    {w:70, h:46}],
    ['manifold', 'Manifold',      {w:80, h:46}],
    ['conduit',  'Conduit',       {w:60, h:40}],
    ['customeq', 'Equipment',     {w:80, h:46, editLabel:true}],
  ]],
  ['Valves & Tees', [
    ['valve2',     '2-Way Valve',    {w:50, h:50}],
    ['valve3',     '3-Way Valve',    {w:75, h:60}],
    ['checkvalve', 'Check Valve',    {w:55, h:40}],
    ['actuated',   'Actuated Valve', {w:60, h:50}],
    ['tee',        'Tee',            {w:40, h:40}],
  ]],
];
